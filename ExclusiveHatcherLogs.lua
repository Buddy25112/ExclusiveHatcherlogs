_G.TrackList1 = {
    ['Basic'] = false; -- Set this to true if you want Basic pets to appear
    ['Rare'] = false; -- Set this to true if you want Rare pets to appear
    ['Epic'] = false; -- Set this to true if you want Epic pets to appear
    ['Legendary'] = false; -- Set this to true if you want Legendary pets to appear
