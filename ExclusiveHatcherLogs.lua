...
if game.PlaceId == 6284583030 or game.PlaceId == 7722306047 then 
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Buddy25112/PetHatchers/main/PSXPetHatcherNormal.lua"))()
elseif game.PlaceId == 10321372166 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Buddy25112/PetHatchers/main/PSXPetHatcherHardCore.lua"))()
else
